...
MINIO_ACCESS=YX0Q15RENVBF6FQZZ8BD MINIO_SECRET=0fC0ypCecVIwiGZn68l4+8r5nwzv89Rdgf8aBbas podman compose -f compose.assets.yaml -p assets-service up --build --force-recreate -d;
